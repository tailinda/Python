...
for i in range (1, 3):
    ...
    for n in range(0, len(branch_name)):
        m = 15*(i-1) + n
        df.loc[m] = [branch_name[n], category_temp_result1[n], category_temp_result2[n], category_temp_result3[n], 
               category_temp_result4[n], avg_price_result[n], address[n], star_result[n], review_count_result[n]]
